...
definiert. Das Listing \ref{rules} beinhaltet die Basis-Fakten. Die Grundlage bildet die Bestimmung der \textit{Eligibility}: Ein 
...
\begin{lstlisting}[caption={ASP-Regeln},label={rules}]
eligible(U, S) :-
user(U), station(S),
