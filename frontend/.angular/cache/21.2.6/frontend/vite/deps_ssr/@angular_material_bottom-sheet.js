...
var MatBottomSheetRef = class {
  ...
  constructor(_ref, config, containerInstance) {
    ...
    this.disableClose = config.disableClose;
    containerInstance._animationStateChanged.pipe((0, import_operators2.filter)((event) => event.phase === "done" && event.toState === "visible"), (0, import_operators2.take)(1)).subscribe(() => {
      this._afterOpened.next();
      this._afterOpened.complete();
    });
    containerInstance._animationStateChanged.pipe((0, import_operators2.filter)((event) => event.phase === "done" && event.toState === "hidden"), (0, import_operators2.take)(1)).subscribe(() => {
    ...
    (0, import_rxjs2.merge)(this.backdropClick(), this.keydownEvents().pipe((0, import_operators2.filter)((event) => event.keyCode === ESCAPE))).subscribe((event) => {
  ...
  dismiss(result) {
    ...
    this.containerInstance._animationStateChanged.pipe((0, import_operators2.filter)((event) => event.phase === "start"), (0, import_operators2.take)(1)).subscribe(() => {
