% !TeX document-id = {d8f07460-fbe0-48cb-93dd-3e08479e6d56}
% !TeX program = xelatex
% !TeX encoding = UTF-8
...
%% 
\documentclass[a4paper,oneside,10pt,english,ngerman]{scrbook}
%% 
...
%% 
\usepackage[bathesis,fancyfonts,mathastext, SOWI]{jkureport}
%% 
...
\title{Ein ASP-basierter Ansatz zur Lösung des Nurse Scheduling Problems mit Clingo}
...
\author{ Tobias~Rafetseder\matno{12306137}}
...
\supervisor{\prefix{o. Univ.-Prof. Dipl.-Ing. Dr.} Michael~Schrefl}

%% Command \assistantsupervisor{name}: sets the name of the assistant supervisor(s)
\assistantsupervisor{\prefix{Dipl.-Ing.} Sebastian~Windsperger}
...
\submissiondepartment{Institut für Wirtschaftsinformatik - Data and Knowledge Engineering}
...
\import{./}{03-grundlagen}
\import{./}{04-related-work}
\import{./}{05-requirements-architecture}
\import{./}{06-rest}
\import{./}{07-asp}
% ...
