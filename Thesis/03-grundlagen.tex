...
\end{lstlisting}
Hier leuchtet die Lampe, wenn der Strom an ist und es keinen Grund gibt anzunehmen, dass sie kaputt ist. Ist nichts über einen Defekt bekannt, gilt \texttt{not broken}, und die Lampe leuchtet.
Wenn \texttt{lightning} als Fakt hinzukommt, wird \texttt{broken} ableitbar, und \texttt{not broken} gilt nicht mehr, also leuchtet die Lampe nicht mehr.
